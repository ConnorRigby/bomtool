...
const D_SMA_DNP = @embedFile("library/D_SMA_DNP.kicad_sym_part");
...
pub fn render(allocator: std.mem.Allocator, product_symbols: []symbol.ProductSymbol) ![]const u8 {
    ...
    return fmt.allocPrint(allocator,
        ...
        \\{s})
        \\
    , .{ R_0402_DNP, R_0603_DNP, R_0805_DNP, R_1206_DNP, C_0402_DNP, C_0603_DNP, C_0805_DNP, D_SMA_DNP, library_symbols.items });
}
